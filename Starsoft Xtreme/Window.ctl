VERSION 5.00
Begin VB.UserControl Window 
   ClientHeight    =   2520
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4680
   ControlContainer=   -1  'True
   PropertyPages   =   "Window.ctx":0000
   ScaleHeight     =   2520
   ScaleWidth      =   4680
   ToolboxBitmap   =   "Window.ctx":0026
   Begin VB.Image Image12 
      Height          =   300
      Left            =   3960
      Picture         =   "Window.ctx":0338
      Top             =   0
      Width           =   240
   End
   ...
   Begin VB.Image Image5 
      Height          =   120
      Left            =   4320
      MouseIcon       =   "Window.ctx":1626
      MousePointer    =   99  'Custom
      Picture         =   "Window.ctx":1930
      Top             =   2400
      Width           =   330
   End
